      ...
      <div className="max-w-7xl mx-auto px-6 py-12 relative">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10 mb-10">
          ...
          <div className="sm:col-span-2 lg:col-span-2">
            <p className="text-lg font-bold text-foreground mb-3">Keene Xander Brigado</p>
            <p className="text-muted text-sm leading-relaxed max-w-sm mb-4">
              Management Engineering Student &amp; Operations Consultant at Ateneo de Manila University. Bridging Code, Operations, and AI.
            </p>
          ...
          {/* Explore */}
          <div>
            <p className="text-xs font-semibold text-foreground uppercase tracking-widest mb-4">Explore</p>
          ...
          {/* More */}
          <div>
            <p className="text-xs font-semibold text-foreground uppercase tracking-widest mb-4">More</p>
            <ul className="flex flex-col gap-2">
